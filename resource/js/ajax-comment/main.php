...
if (!function_exists('fa_ajax_comment_scripts')) :
    ...
    function fa_ajax_comment_scripts()
    {
        if (is_singular() && comments_open() && get_option('thread_comments')) {
            ...
            wp_enqueue_style('ajax-comment', get_template_directory_uri() . '/resource/js/ajax-comment/app.css', array(), AC_VERSION);
            wp_enqueue_script('ajax-comment', get_template_directory_uri() . '/resource/js/ajax-comment/app.js', array(), AC_VERSION, true);
